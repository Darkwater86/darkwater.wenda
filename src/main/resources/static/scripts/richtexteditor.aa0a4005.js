(function (z) {
    ...
    var aJ = function (a, b, c, d, f) {
        ...
        if (z.C) {
            ...
            H = a.F;
            !H.nc() && !d && m in cJ && (H = H.m(), n && n.isCollapsed() && !z.gf(H) && (d = n.Be(0).ce(), n = d.duplicate(), n.moveToElementText(H), n.collapse(!1), n.isEqual(d) && (n = h.createTextNode(" "), H.appendChild(n), d.move("character", 1), d.move("character", -1), d.select(), k.push(n))), d = h.B("DIV", {style: "height:0"}), H.appendChild(d), k.push(d));
            h = k[0];
            k = k[1]
        }
        if (z.D) {
    ...
    var vK = function (a) {
        var b = z.xA(a), c = (0, window.$)('\x3cdiv class\x3d"editable-dropzone"\x3e\x3cdiv class\x3d"row"\x3e\x3cdiv class\x3d"cell"\x3e\x3cdiv\x3e拖拽至此处上传\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e');
        b.bz(c[0], a.F.m());
        return c
    };
    var wK = function (a) {
        var b = z.xA(a), c = b.B("IMG", {
            "class": "",
            style: "display:block",
            src: z.rm.wB + "/img/spinner2.gif"
        }), d = z.ZA(a.F);
    ...
    var nL = function (a, b) {
        ...
        for (var d = z.J(a), f = [], g = 0, h; h = c[g]; g++) {
            if (z.pa(h)) {
                var k = void 0;
                if (h = z.kH[h]) {
                    var k = h.factory || z.YE, m = h.Aa, n = h.R, r = h.caption, w = h.Pa, H = d || z.J(), k = k(m, n, r, w, null, H);
                    h.mb && (k.mb = !0)
                }
                h = k
            }
    ...
    var XI = z.C ? /<br([^\/>]*)\/?>/gi : /<br([^\/>]*)\/?>(?!<\/(div|p)>)/gi, cJ = {
        ...
        ltr: 1,
        rtl: 1
    }, bJ = {insertOrderedList: 1, insertUnorderedList: 1}, mJ = {1: 1, a: 1, A: 1, i: 1, I: 1}, lJ = {
        disc: 1,
        circle: 1,
        square: 1
    }, dJ = {
    ...
    z.e.SP = function (a) {
        ...
        if (8 == a.keyCode) {
            ...
            if (!a.shiftKey) {
                var c = z.ZA(this.F), b = !c || c.isCollapsed(), d = xJ(this), f = this.F.execCommand("+splitBlockquote", d);
    ...
    z.e.zw = 0;
    z.e.B = function () {
        var a = z.u("TeX 公式"), b = z.u("预览"), c = z.u("了解更多"), d = this.da, c = d.B("DIV", {style: "display: none;"}, d.B("SPAN", {"class": "ee-section-title ee-section-title-floating"}, a), this.Lj ? d.B("A", {
    ...
    WJ.prototype.Lw = function () {
        var a = new z.PD(this), b = z.u("公式编辑器"), c = z.u("插入公式"), d = z.u("保存修改"), f = z.u("取消"), c = this.uj.Cl() ? d : c;
    ...
    var GK = [["ABAP", "abap"], ["ABNF", "abnf"], ["ActionScript 3", "as3"], ["ActionScript", "as"], ["Ada", "ada"], ["ADL", "adl"], ["Agda", "agda"], ["Alloy", "alloy"], ["AmbientTalk", "at"], ["ANTLR", "antlr"], ["ApacheConf", "apacheconf"], ["APL", "apl"], ["AppleScript", "applescript"], ["Arduino", "arduino"], ["AspectJ", "aspectj"], ["aspx-cs", "aspx-cs"], ["aspx-vb", "aspx-vb"], ["Asymptote", "asy"], ["autohotkey", "ahk"], ["AutoIt", "autoit"], ["Awk", "awk"], ["Base Makefile", "basemake"], ["Bash Session", "console"], ["Bash", "bash"], ["Batchfile",
        ...
        ["Rust", "rust"], ["S", "splus"], ["Sass", "sass"], ["Scala", "scala"], ["Scalate Server Page", "ssp"], ["Scaml", "scaml"], ["Scheme", "scheme"], ["Scilab", "scilab"], ["SCSS", "scss"], ["Shen", "shen"], ["Slim", "slim"], ["Smali", "smali"], ["Smalltalk", "smalltalk"], ["Smarty", "smarty"], ["Snobol", "snobol"], ["SourcePawn", "sp"], ["SPARQL", "sparql"], ["SQL", "sql"], ["sqlite3con", "sqlite3"], ["SquidConf", "squidconf"], ["Stan", "stan"], ["Standard ML", "sml"], ["SuperCollider", "sc"], ["Swift", "swift"], ["SWIG", "swig"], ["systemverilog",
            ...
            "verilog"], ["VGL", "vgl"], ["vhdl", "vhdl"], ["VimL", "vim"], ["X10", "x10"], ["XML", "xml"], ["XQuery", "xquery"], ["XSLT", "xslt"], ["Xtend", "xtend"], ["XUL+mozpreproc", "xul+mozpreproc"], ["YAML", "yaml"], ["YAML+Jinja", "yaml+jinja"], ["Zephir", "zephir"]], IK = z.nb(GK, EK);
    z.e = DK.prototype;
    z.e.defaults = {
        tV: "lang-select",
        tr: "collapsed",
    ...
    z.e.Lw = function () {
        var a = z.rm.tq + "/upload_video", a = this.kd.B("div", "zm-img-uploader zm-img-uploader-upload-tab-selected", [this.kd.B("div", "zg-section", this.kd.B("strong", null, "输入视频页地址：")), this.kd.B("iframe", {
            id: "video_up_frame",
            src: "about:_blank",
            name: "video_up_frame",
